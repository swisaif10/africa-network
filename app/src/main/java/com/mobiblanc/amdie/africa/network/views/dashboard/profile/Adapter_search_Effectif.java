...
import com.mobiblanc.amdie.africa.network.models.search.init_montoring.Effectif;
import com.mobiblanc.amdie.africa.network.models.search.init_montoring.ObjetReferenceValuesItem;

public class Adapter_search_Effectif extends RecyclerView.Adapter<Adapter_search_Effectif.ViewHolder> {

    private final Context context;
    private final Effectif data;
    private final CheckedLisner checkedLisner;


    public Adapter_search_Effectif(Context context, Effectif data, CheckedLisner checkedLisner) {
    ...
    @NonNull
    @Override
    public Adapter_search_Effectif.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Adapter_search_Effectif.ViewHolder(AdapterCheckboxBinding.inflate(
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_search_Effectif.ViewHolder holder, int position) {
    ...
    void enable_check(Boolean enable) {
        ...
        checkedLisner.Checked_Effectif(nbr_check() > 0, getList_id_String(), getList_name_String());
    }
